...
/* Prices are branch-specific and are NOT baked into the base catalog: an item's
   price stays undefined until a branch is chosen, then comes from that branch's
